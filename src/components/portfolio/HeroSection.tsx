...
const HeroSection = () => {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-vibrant-yellow to-secondary px-4 dark:from-primary dark:to-accent">
